...
// in learn_clean_architecture/test/presentation/bloc/weather_bloc_test.dart.
...
import 'package:learn_clean_architecture/core/error/failure.dart' as _i6;
import 'package:learn_clean_architecture/domain/entities/weather.dart' as _i7;
...
class MockGetCurrentWeatherUseCase extends _i1.Mock
  ...
  @override
  _i5.Future<_i3.Either<_i6.Failure, _i7.WeatherEntity>> execute(
          String? cityName) =>
      (super.noSuchMethod(
        Invocation.method(
          #execute,
